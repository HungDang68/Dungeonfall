...
public class AStarTest : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        finishPathTile = GameResources.Instance.enemyUnwalkableCollissionTilesArray[0];
    }


    private void StaticEventHandler_OnRoomChanged(RoomChangedEventArgs roomChangedEventArgs)
    {
        if (roomChangedEventArgs.room == null || roomChangedEventArgs.room.instatiatedRoom == null)
        {
            Debug.LogError("Room or InstantiatedRoom is null in OnRoomChanged.");
            return;
        }
        pathStack = null;
        instantiatedRoom = roomChangedEventArgs.room.instatiatedRoom;
    ...
    private void SetStartPosition()
    {
        ...
        {
            startGridPosition = grid.WorldToCell(HelpfulUtility.GetMousePosition());
    ...
    private void SetEndPosition()
    {
        ...
        {
            endGridPosition = grid.WorldToCell(HelpfulUtility.GetMousePosition());
