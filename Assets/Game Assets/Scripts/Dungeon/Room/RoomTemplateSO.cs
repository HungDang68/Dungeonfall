...
public class RoomTemplateSO : ScriptableObject
{
    ...
    public List<SpawnableObjectByLevel<EnemyDetailsSO>> enemysByLevelList;
    ...
    private void OnValidate()
    {
        ...
        HelpfulUtility.ValidateCheckEnumerableValues(this, nameof(doorwayList), doorwayList);

        // Check spawn positions populated
        HelpfulUtility.ValidateCheckEnumerableValues(this, nameof(spawnPositionArray), spawnPositionArray);
    }
